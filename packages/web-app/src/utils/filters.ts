import { ref } from 'vue';
import { resolveUnref } from '@/utils/resolveUnref';
import { Fn, MaybeComputedRef, Pausable } from '@/utils/types';

export type FunctionArgs<Args extends any[] = any[], Return = void> = (...args: Args) => Return;

export interface FunctionWrapperOptions<Args extends unknown[] = unknown[], This = unknown> {
...
export function pausableFilter(extendFilter: EventFilter = bypassFilter): Pausable & { eventFilter: EventFilter } {
  ...
  return {
    isActive, pause, resume, eventFilter,
  };
}
